...
## 1.17 (15/05/2026)
- Ajout d'un garde-fou a la creation automatique de projet a la signature d'un devis : si le client a deja un projet, l'utilisateur choisit entre rattacher le devis a un projet existant ou creer un nouveau projet.
