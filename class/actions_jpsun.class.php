...
**/
    ...
    public function addMoreMassActions($parameters, &$object, &$action, $hookmanager)
    {
		...
		if ($isCompatibleVersion && (in_array('tasklist', $contexts) || in_array('projecttaskscard', $contexts))) {
			$this->resprints .= '<option value="jpsun_cloturer_taches_projet"'.($canCloseTasks ? '' : ' disabled="disabled"').' style="font-family: FontAwesome, \'Font Awesome 5 Free\'; font-weight: 900;">&#xf00c; '.$langs->trans('JpsunMassActionCloturerTachesProjet').'</option>';
		}
