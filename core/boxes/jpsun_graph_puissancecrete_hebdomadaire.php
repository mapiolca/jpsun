...
class jpsun_graph_puissancecrete_hebdomadaire extends ModeleBoxes
{
	...
	public function loadBox($max = 5)
	{
		...
		$this->info_box_head = array('text' => $langs->trans('JpsunWidgetPuissanceCreteHebdoTitle').' '.img_picto($langs->trans('JpsunWidgetPuissanceCreteInfo'), 'info', 'class="opacitymedium"'), 'limit' => 0);
