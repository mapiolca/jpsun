...
class jpsun_graph_puissancecrete_mensuelle extends ModeleBoxes
{
	...
	public function loadBox($max = 5)
	{
		...
		$this->info_box_head = array('text' => $langs->trans('JpsunWidgetPuissanceCreteMensuelTitle').' '.img_picto($langs->trans('JpsunWidgetPuissanceCreteInfo'), 'help', 'class="opacitymedium"'), 'limit' => 0);
		$graphData = array();
		$total = 0.0;
		for ($m = 1; $m <= 12; $m++) {
