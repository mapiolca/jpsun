...
/**
 *	\file       htdocs/core/modules/fichinter/doc/pdf_fichinterjpsun.modules.php
 *	\ingroup    ficheinter
 *	\brief      File of Class to build interventions documents with model fichinterjpsun
 */
...
/**
 *	Class to build interventions documents with model fichinterjpsun
 */
class pdf_fichinterjpsun extends ModelePDFFicheinter
{
	/**
