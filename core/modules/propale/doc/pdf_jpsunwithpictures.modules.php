 ...
 */
class pdf_jpsunwithpictures extends ModelePDFPropales
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = $langs->trans('JpsunWithPicturesName');
		$this->description = $langs->trans('DocModelJpsunWithPicturesDescription');
