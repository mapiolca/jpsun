 ...
 */
class pdf_jpsunwithprices extends ModelePDFSupplierProposal
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = $langs->trans('DocModelJPSUNwithpricesName');
		$this->description = $langs->trans('DocModelJPSUNwithpricesDescription');
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		if (getDolGlobalString('PDF_SHOW_PROJECT')) {
			...
			if (!empty($object->project->ref)) {
				...
				$langs->load("projects");
				$pdf->SetTextColor(0, 0, 60);
				$pdf->MultiCell(100, 3, $outputlangs->transnoentities("RefProject")." : ".(empty($object->project->ref) ? '' : $object->project->ref), '', 'R');
			}
		}
